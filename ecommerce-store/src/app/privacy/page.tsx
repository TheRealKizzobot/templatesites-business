export const metadata = {
  title: "Privacy Policy — Northlight Goods",
  description: "Privacy Policy for Northlight Goods.",
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12" style={{ color: "var(--text-secondary)" }}>
            <section>
              ...
              <p className="mb-4">
                When you interact with Northlight Goods, we may collect:
              </p>
            ...
            <section>
              ...
              <p>
                Questions about this policy? Email us at <a href="mailto:info@northlightgoods.example.com" className="underline" style={{ color: "var(--brand)" }}>info@northlightgoods.example.com</a>
              </p>
            </section>
          </div>
        </div>
