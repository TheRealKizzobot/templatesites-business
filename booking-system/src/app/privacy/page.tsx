export const metadata = {
  title: "Privacy Policy — Book SITE_NAME Dine",
  description: "Privacy Policy for Book SITE_NAME Dine.",
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12" style={{ color: "var(--text-secondary)" }}>
            <section>
              ...
              <p className="mb-4">
                When you interact with Book SITE_NAME Dine, we may collect:
              </p>
            ...
            <section>
              ...
              <p>
                Questions about this policy? Email us at <a href="mailto:info@bookdine.example.com" className="underline" style={{ color: "var(--brand)" }}>info@bookdine.example.com</a>
              </p>
            </section>
          </div>
        </div>
