export const metadata = {
  title: "Cookie Policy — Book SITE_NAME Dine",
  description: "Cookie Policy for Book SITE_NAME Dine.",
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12" style={{ color: "var(--text-secondary)" }}>
            ...
            <section>
              ...
              <p>Book SITE_NAME Dine uses the following categories of cookies:</p>
            ...
            <section>
              ...
              <p>
                Questions about this policy? Email <a href="mailto:info@bookdine.example.com" className="underline" style={{ color: "var(--brand)" }}>info@bookdine.example.com</a>
              </p>
            </section>
          </div>
        </div>
