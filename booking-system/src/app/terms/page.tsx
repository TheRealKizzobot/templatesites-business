export const metadata = {
  title: "Terms of Service — Book SITE_NAME Dine",
  description: "Terms of Service for Book SITE_NAME Dine.",
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12" style={{ color: "var(--text-secondary)" }}>
            <section>
              ...
              <p>
                By using Book SITE_NAME Dine, you agree to these Terms. If you disagree, do not use the site.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Questions? Email <a href="mailto:info@bookdine.example.com" className="underline" style={{ color: "var(--brand)" }}>info@bookdine.example.com</a>
              </p>
            </section>
          </div>
        </div>
