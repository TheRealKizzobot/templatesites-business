export const metadata = {
  title: "Cookie Policy — Metrics",
  description: "Cookie Policy for Metrics.",
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12" style={{ color: "var(--text-secondary)" }}>
            ...
            <section>
              ...
              <p>Metrics uses the following categories of cookies:</p>
            ...
            <section>
              ...
              <p>
                Questions about this policy? Email <a href="mailto:info@metrics.example.com" className="underline" style={{ color: "var(--brand)" }}>info@metrics.example.com</a>
              </p>
            </section>
          </div>
        </div>
